            ...
            if (i < hero.inventory.length) { 
                ...
                if (item) { 
                    ...
                    if (item.type === 'consumable') {
                        forgeHtml += `<div class="inv-item filled rarity-${item.rarity} ${selClass} blocked" style="filter: grayscale(100%) opacity(0.4); pointer-events: none;" onclick="selectForgeItem(${i})">${renderItemIcon(item)}</div>`; 
                    } else {
