...
function updateUI() {
    ...
    if (currentScreen === 'PVE' && enemy) {
        ...
        let eCard = document.querySelector("#entity-enemy-box .combat-card");
        if(eCard) eCard.className = (enemy.isBoss || enemy.isRaid || enemy.isPlayer) ? "combat-card boss" : "combat-card";
